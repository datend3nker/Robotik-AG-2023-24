...
def arbeitsstunden_gesammt(arbeitsstunden: dict) -> int:
    ...
    Examples:
        ...
        43
    """
    return sum(arbeitsstunden.values())
...
def tag_mit_den_meisten_stunden(arbeitsstunden: dict) -> str:
    ...
    Examples:
        ...
        'Freitag'
    """
    return max(arbeitsstunden, key=arbeitsstunden.get)
...
def erfolgreiche_woche(arbeitsstunden: dict) -> bool:
    ...
    Examples:
        ...
        True
    """
    for day, hours in arbeitsstunden.items():
        if day == "Sonntag" or day == "Samstag":
            continue
        elif hours < 6:
            return False
    return True
...
def arbeitsstunden_in_minuten(arbeitsstunden: dict) -> dict:
    ...
    """
    return {day: hours * 60 for day, hours in arbeitsstunden.items()}
